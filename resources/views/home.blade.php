...
<div class="image">
<img src="MY PHOTO.jpg" class="img-circle elevation-2" alt="User Image">
</div>
<div class="info">
<a href="#" class="d-block">Schoo Menegment</a>
</div>
</div>
...
<div class="inner">
    <h3>{{ @$total_courses }}<sup style="font-size: 20px">%</sup></h3>
<p>COURSES</p>
</div>
<div class="icon">
<i class="ion ion-stats-bars"></i>
</div>
<a href="{{ url('courses') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
</div>
</div>
...
<a href="enrollments" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
</div>
</div>
...
<strong>Copyright &copy; 2023 <a href="https://adminlte.io">School Menegment</a>.</strong>
All rights reserved.
