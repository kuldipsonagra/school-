...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('enrollments/' .$enrollments->id) }}" method="post">
        ...
        <input type="text" name="batch_id" id="address" value="{{$enrollments->batch_id}}" class="form-control"></br>
        <label>Student</label></br>
        <input type="text" name="student_id" id="student_id" value="{{$enrollments->student_id}}" class="form-control"></br>
        <label>Join Date</label></br>
        <input type="text" name="join_date" id="join_date" value="{{$enrollments->join_date}}" class="form-control"></br>        <label>Mobile</label></br>
        <label>Fee</label></br>
